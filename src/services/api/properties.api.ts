...
export interface CreatePropertyDto {
    ...
    images?: string[];
    videos?: string[];
    /** Backend expects { icon, label } per item (same as user form) */
...
export const propertiesApi = {
    ...
    getPendingProperties: async (page: number = 1, limit: number = 20) => {
        return apiClient.get<PaginatedResponse<Property>>(`/admin/properties/pending?page=${page}&limit=${limit}`);
    },
};
