...
export const navigationMenu: SidebarMenuItem[] = [
    {
        ...
        path: '/dashboard',
        roles: ['admin', 'admin_property', 'admin_services', 'agent', 'real_estate_agency', 'landlord', 'service_provider', 'home_seeker'],
    },
    {
        key: 'properties',
        label: 'Properties',
        icon: <HomeOutlined />,
        path: '/properties',
        roles: ['admin', 'admin_property', 'agent', 'real_estate_agency', 'landlord'],
    },
    {
        key: 'services',
        label: 'Services',
        icon: <ShopOutlined />,
        path: '/services',
        roles: ['admin', 'admin_services', 'service_provider'],
    },
    {
        key: 'agents',
        label: 'Agents',
    ...
    },
    {
        ...
        path: '/messages',
        roles: ['admin', 'admin_property', 'admin_services', 'agent', 'real_estate_agency', 'landlord', 'service_provider'],
    },
    {
        key: 'notifications',
        label: 'Notifications',
    ...
    },
    {
        ...
        icon: <UserOutlined />,
        path: '/profile',
        roles: ['admin', 'agent', 'real_estate_agency', 'landlord', 'service_provider', 'home_seeker'],
    },
    {
        key: 'settings',
        label: 'Settings',
