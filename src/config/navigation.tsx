...
export const navigationMenu: SidebarMenuItem[] = [
    {
        ...
        path: '/dashboard',
        roles: ['admin', 'admin_property', 'admin_services', 'agent', 'landlord', 'service_provider', 'home_seeker'],
    },
    {
        key: 'properties',
        label: 'Properties',
        icon: <HomeOutlined />,
        path: '/properties',
        roles: ['admin', 'admin_property', 'agent', 'landlord'],
    },
    {
        key: 'services',
        label: 'Services',
    ...
    },
    {
        ...
        path: '/messages',
        roles: ['admin', 'admin_property', 'admin_services', 'agent', 'landlord', 'service_provider'],
    },
    {
        key: 'notifications',
        label: 'Notifications',
